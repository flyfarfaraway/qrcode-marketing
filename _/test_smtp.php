 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	$from="ftp@qrcode-marketing.com";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	$to="phamthanhdat.bk@gmail.com";                             /* Change this to your test recipient address */ $recipient_line=__LINE__;
