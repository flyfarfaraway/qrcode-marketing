...
class es_cls_widget {
	public static function load_subscription($arr) {
		...
		$es .= '<div class="es_textbox">';
			$es .= '<input type="text" id="es_txt_email_pg" class="es_textbox_class" name="es_txt_email_pg" placeholder="Email" onkeypress="if(event.keyCode==13) es_submit_pages(event, '.$url.')" value="" maxlength="225">';
		$es .= '</div>';
